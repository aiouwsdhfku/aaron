							...
							<div class="row">
								<div class="col-sm-12">
									<div class="item-content colBottomMargin">
										<div class="item-info">
											<h2 class="item-title text-center">Has tu Reservacion</h2>
										</div><!--End item-info -->
								...
								<form name="contactform" action="registrarContrato.php" method="POST" data-toggle="validator" class="popup-form">
			                        <div class="row">
			                          ...
			                          <div class="form-group col-sm-6">
			                            <div class="help-block with-errors"></div>
			                            <input name="numeroBanquetes" id="numeroBanquetes" placeholder="Numero de banquetes a ordenar*" class="form-control" type="number" value="1" required data-error="Por favor ingresa el numero de Productos" min="1"> 
			                            <div class="input-group-icon"><i class="fa fa-user"></i></div>
			                          </div><!-- end form-group -->
			                          <div class="form-group col-sm-6">
			                            <div class="help-block with-errors"></div>
			                            <input name="fechaEvento" id="fechaEvento" placeholder="Fecha del evento*" class="form-control" type="date" required data-error="Por favor ingresa la fecha de la reserva">
			                            <div class="input-group-icon"><i class="fa fa-book"></i></div>
			                          </div><!-- end form-group -->
			                          <div class="form-group col-sm-6">
			                            <div class="help-block with-errors"></div>
			                              <select name="banquete" id="banquete" class="form-control" required="Por favor seleccione un producto">
		...
		<div class="container">			
			...
			<div class="row">					
				<div class="footer-top col-sm-12">
					<p class="text-center copyright">Cafe y Chocolate Palosantuyoc</p>
				</div><!-- end col --> 
			</div><!-- end row -->
